...
export default class StrengthUI {
    constructor(scene, strength) {
        this.oneQuarterText = scene.add.text(Config.WINDOW_WIDTH / 2, Config.PADDING_ELEMENTS, (0.25 * 100).toFixed(0) + "%", {
        ...
        this.oneQuarterText.setX(this.oneQuarterText.x - this.oneQuarterText.width * 2);
        this.oneQuarterText.setAlpha(1.0);
        this.twoQuartersText = scene.add.text(Config.WINDOW_WIDTH / 2, Config.PADDING_ELEMENTS, (0.5 * 100).toFixed(0) + "%", {
            backgroundColor: toHexColor(Color.TOOLTIP_BACKGROUND),
            color: toHexColor(Color.TEXT_DEFAULT),
            padding: { x: Config.PADDING_TEXT, y: Config.PADDING_TEXT },
            fontFamily: "CaskaydiaMono",
        ...
        this.twoQuartersText.setX(this.twoQuartersText.x - this.twoQuartersText.width * 1);
        this.twoQuartersText.setAlpha(1.0);
        this.threeQuartersText = scene.add.text(Config.WINDOW_WIDTH / 2, Config.PADDING_ELEMENTS, (0.75 * 100).toFixed(0) + "%", {
            backgroundColor: toHexColor(Color.TOOLTIP_BACKGROUND),
            color: toHexColor(Color.TEXT_DEFAULT),
            padding: { x: Config.PADDING_TEXT, y: Config.PADDING_TEXT },
            fontFamily: "CaskaydiaMono",
        ...
        this.threeQuartersText.setX(this.threeQuartersText.x - this.threeQuartersText.width * 0);
        this.threeQuartersText.setAlpha(1.0);
        this.fourQuartersText = scene.add.text(Config.WINDOW_WIDTH / 2, Config.PADDING_ELEMENTS, (1.0 * 100).toFixed(0) + "%", {
            backgroundColor: toHexColor(Color.TOOLTIP_BACKGROUND),
            color: toHexColor(Color.TEXT_DEFAULT),
            padding: { x: Config.PADDING_TEXT, y: Config.PADDING_TEXT },
            fontFamily: "CaskaydiaMono",
        ...
        this.fourQuartersText.setX(this.fourQuartersText.x + this.fourQuartersText.width * 1);
        this.fourQuartersText.setAlpha(1.0);
        this.updateStrengthIndicator(strength);
    }
    updateStrengthIndicator(strength) {
        this.oneQuarterText.setBackgroundColor(toHexColor(Color.TOOLTIP_BACKGROUND));
        this.twoQuartersText.setBackgroundColor(toHexColor(Color.TOOLTIP_BACKGROUND));
        this.threeQuartersText.setBackgroundColor(toHexColor(Color.TOOLTIP_BACKGROUND));
        this.fourQuartersText.setBackgroundColor(toHexColor(Color.TOOLTIP_BACKGROUND));
        if (strength == 0.25) {
...
//# sourceMappingURL=StrengthUI.js.map